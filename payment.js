...
payBtn.addEventListener('click', () => {
    try {
        ...
        // Strip all non-alphanumeric chars from matrix_no (removes slashes, spaces, dots etc.)
        const safeMatrix = student.matrix_no.replace(/[^A-Z0-9]/gi, '').toUpperCase();
        const randomChars = () => {
        ...
        const reference = 'BRAINSAI' + safeMatrix + Date.now() + randomChars();
