...
window.onload = async function() {
    ...
    try {
        ...
        // Defensive validation extracting parameters safely regardless of underscore names
        const rawMatrix = real.matrix_no || real.matrix || "N/A";
        const rawDept = real.department || real.dept || "N/A";
        const rawName = real.name || "Student";
        ...
        // Display student details in DOM elements
        ...
        if (document.getElementById('welcomeText')) {
            document.getElementById('welcomeText').innerText = "⚠️ Could not load profile details. Please try refreshing.";
        }
    }
};
