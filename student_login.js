...
async function securityCheck() {
    try {
        ...
        // Silent — offline or network error, proceed with caution
    }
}
securityCheck();
...
async function loginUser() {
    ...
    try {
        ...
        if (!myDeviceId) {
            // Use cryptographically secure UUID — not Math.random()
...
async function verifyOTP() {
    ...
    // Client-side pre-check — server also validates expiry
